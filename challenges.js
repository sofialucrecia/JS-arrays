...
const listOfWeekDays = weekDays.toString();
...
const reversedWrittenNumbers = writtenNumbers.reverse();
console.log(reversedWrittenNumbers);
/*------------------
9)
...
const numTimesSeven = num.map((n) => n * 7);
/*------------------
10)
...
var includID = listOfIDs.findIndex(mbjb => mbjb === "1x3v6umb0i9p");
